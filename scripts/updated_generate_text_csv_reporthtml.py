...
OUTPUT_FILE = os.path.join(OUTPUT_FOLDER, f"Tosca_Compact_Report_{timestamp}.html")
...
# ------------------------
# Parse CSV and build TestCases + Steps
# ------------------------
testcases = []
current_tc = None
...
with open(INPUT_FILE, "r", encoding="utf-8") as f:
    ...
    for row in reader:
        ...
        # Add custom description from mapping
...
html_rows = ""
for tc in testcases:
    # TestCase status: Failed if any step failed
...
# HTML Template with table-layout:auto
html_content = f"""
<html>
<head>
<title>Tosca Auto-Width Report</title>
<style>
...
<h1>Tosca Transfer API TestCase Execution Report</h1>
...
print("HTML report generated successfully with auto-width columns!")
